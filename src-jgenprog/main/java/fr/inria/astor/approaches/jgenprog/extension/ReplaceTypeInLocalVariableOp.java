...
public class ReplaceTypeInLocalVariableOp extends ReplaceOp {

    @Override
    public boolean canBeAppliedToPoint(ModificationPoint point) {
        return point.getCodeElement() instanceof CtTypeReference;
    }
    ...
    public boolean applyChangesInModel(OperatorInstance operation, ProgramVariant p) {
        ...
        CtLocalVariable l = (CtLocalVariable) operation.getOriginal();
        CtTypeReference ctst = (CtTypeReference) operation.getOriginal();
