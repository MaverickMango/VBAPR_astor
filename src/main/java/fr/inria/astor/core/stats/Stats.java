...
public class Stats {
	...
	public enum GeneralStatEnum {
		EXECUTION_IDENTIFIER, ENGINE_CREATION_TIME, TOTAL_TIME, NR_GENERATIONS, NR_RIGHT_COMPILATIONS, NR_FAILLING_COMPILATIONS,
		NR_COMPILE_BUT_FAILED, PASSED_FAILING_TESTS, TOTAL_VARIANTS_COMPILED,
